package com.eventhub.dti.infrastructure.auth;
...
public class Claims {
  public static Map<String, Object> getClaimsFromJwt() {
    ...
    Authentication authentication = ((org.springframework.security.core.context.SecurityContext) context).getAuthentication();
